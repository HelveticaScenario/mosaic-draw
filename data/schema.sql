...
GRANT USAGE ON SCHEMA app_hidden TO mosaic_draw_visitor;
...
GRANT USAGE ON SCHEMA app_public TO mosaic_draw_visitor;
...
GRANT ALL ON SCHEMA public TO mosaic_draw;
GRANT USAGE ON SCHEMA public TO mosaic_draw_visitor;
...
GRANT SELECT ON TABLE app_public.users TO mosaic_draw_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO mosaic_draw_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO mosaic_draw_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.accept_invitation_to_organization(invitation_id uuid, code text) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.confirm_account_deletion(token text) TO mosaic_draw_visitor;
...
GRANT SELECT ON TABLE app_public.organizations TO mosaic_draw_visitor;
...
GRANT UPDATE(slug) ON TABLE app_public.organizations TO mosaic_draw_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.organizations TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.create_organization(slug public.citext, name text) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.current_session_id() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public."current_user"() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_id() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_invited_organization_ids() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_member_organization_ids() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.delete_organization(organization_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.forgot_password(email public.citext) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.invite_to_organization(organization_id uuid, username public.citext, email public.citext) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.logout() TO mosaic_draw_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO mosaic_draw_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.make_email_primary(email_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.organization_for_invitation(invitation_id uuid, code text) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_billing_contact(org app_public.organizations) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_owner(org app_public.organizations) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.remove_from_organization(organization_id uuid, user_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.request_account_deletion() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.resend_email_verification_code(email_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.reset_password(user_id uuid, reset_token text, new_password text) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.tg__graphql_subscription() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__forbid_if_verified() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__verify_account_on_verified() TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_billing_contact(organization_id uuid, user_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_ownership(organization_id uuid, user_id uuid) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.users_has_password(u app_public.users) TO mosaic_draw_visitor;
...
GRANT ALL ON FUNCTION app_public.verify_email(user_email_id uuid, token text) TO mosaic_draw_visitor;
...
GRANT SELECT ON TABLE app_public.organization_invitations TO mosaic_draw_visitor;
...
GRANT SELECT ON TABLE app_public.organization_memberships TO mosaic_draw_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_hidden REVOKE ALL ON SEQUENCES  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_hidden REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_hidden REVOKE ALL ON FUNCTIONS  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_hidden GRANT ALL ON FUNCTIONS  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_public REVOKE ALL ON SEQUENCES  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_public REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_public REVOKE ALL ON FUNCTIONS  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA app_public GRANT ALL ON FUNCTIONS  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA public REVOKE ALL ON SEQUENCES  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA public GRANT SELECT,USAGE ON SEQUENCES  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA public REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA public REVOKE ALL ON FUNCTIONS  FROM mosaic_draw;
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw IN SCHEMA public GRANT ALL ON FUNCTIONS  TO mosaic_draw_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE mosaic_draw REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
